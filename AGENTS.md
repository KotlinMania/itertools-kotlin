...
This file is the quick-reference operating contract for itertools-kotlin. The longer
...
itertools-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`itertools`](https://crates.io/crates/itertools). Upstream Rust is the behavioral oracle while the
