...
kotlin {
    ...
    swiftExport {
        ...
        flattenPackage = "io.github.kotlinmania.itertools"
    }

    android {
        namespace = "io.github.kotlinmania.itertools"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "itertools-kotlin", version.toString())

    pom {
        name.set("itertools-kotlin")
        description.set("Kotlin Multiplatform port of rust-itertools/itertools - Extra iterator adaptors, iterator methods, free functions, and macros")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/itertools-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/itertools-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/itertools-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/itertools-kotlin.git")
        }
    }
}
...
dependencies {
    ...
    // itertools-kotlin has no sibling *-kotlin-android AAR dependencies today;
    // the configuration is declared so the codeql.yml extraction task can
    // resolve it unconditionally, per BUILD_TEMPLATE_HANDOFF.md.
}
...
val codeqlCompileJvm = tasks.register<JavaExec>("codeqlCompileJvm") {
    ...
    doFirst {
        ...
        if (sourceFiles.isEmpty()) {
            val sentinelFile = sentinelDir.get().asFile.resolve("io/github/kotlinmania/itertools/CodeqlEmptySentinel.kt")
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleItertoolsXCFramework",
    "assembleItertoolsDebugXCFramework",
    "assembleItertoolsReleaseXCFramework",
    "assembleDebugIosFatFrameworkForItertoolsXCFramework",
    "assembleReleaseIosFatFrameworkForItertoolsXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForItertoolsXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForItertoolsXCFramework",
    "assembleDebugMacosFatFrameworkForItertoolsXCFramework",
    "assembleReleaseMacosFatFrameworkForItertoolsXCFramework",
    "assembleDebugTvosFatFrameworkForItertoolsXCFramework",
    "assembleReleaseTvosFatFrameworkForItertoolsXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForItertoolsXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForItertoolsXCFramework",
    "assembleDebugWatchosFatFrameworkForItertoolsXCFramework",
    "assembleReleaseWatchosFatFrameworkForItertoolsXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForItertoolsXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForItertoolsXCFramework",
